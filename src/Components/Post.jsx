    ...
    >
      ...
      <CardContent>
        <Typography variant="body2" color="text.secondary">
          ...
          <br />
          <Link>
            #personality #love #fashion #enneagram #instagram #photography
            #style #instagood #attitude #motivation #personalitytypes #follow
            #model #life #type #like #psychology #introvert #quotes #lifestyle
            #personalities
          </Link>
        </Typography>
      </CardContent>
